...
<html>
<head>
<title>Flash I - Last Year Enrollment (Secondary Level)</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<link href="../css/style.css" rel="stylesheet" type="text/css">
<script src="js/flash1common.js" type="text/javascript"></script>
<script src="js/last_enroll_sec.js" type="text/javascript"></script>
...
for ($i=9;$i<=10;$i++){
	...
	$result=mysql_query("select * from last_class9_10_enroll_f1 where sch_num='$sch_num' and sch_year='$currentyear' and class=$i");
