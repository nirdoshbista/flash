...
<html>
<head>
<title>Flash I - Enrollment, Repeatation, Migration (Primary Level)</title>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
<link href="../css/style.css" rel="stylesheet" type="text/css">
<script src="js/flash1common.js" type="text/javascript"></script>
<script src="js/enr_rep_mig_pr.js" type="text/javascript"></script>
...
for ($i=1;$i<=5;$i++){
	...
	$result=mysql_query("select * from enr_rep_mig_class1_5_f1 where sch_num='$sch_num' and sch_year='$currentyear' and class=$i");
