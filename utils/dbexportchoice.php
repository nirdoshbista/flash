...
<form name="form1" method="post" action="dbexport.php" onsubmit="document.getElementById('exportform').className='divhide'; document.getElementById('working').className='divshow'; return true;">
  <p align='center'>
	...
	<label> <input type="checkbox" name="f1" value="1" checked />Flash I </label>
	<label> <input type="checkbox" name="f2" value="1" checked />Flash II </label>
	<label> <input type="checkbox" name="tmis" value="1" checked />TMIS </label>
	
  </p>
  
  <p align='center'>
  <label> <input type="checkbox" name="photos" value="1" />Include Photos </label>
  </p>
...
<div id='working' class='divhide'><p align='center'>Exporting data ... <br /><img src='working.gif'></p></div>
