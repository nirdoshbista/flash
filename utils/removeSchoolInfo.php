...
<html>
    <head>
        <title>Remove imported EMIS data</title>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
        <script src="../includes/jQuery 1.11/jQuery 1.11.js" type="text/javascript"></script>
        
        <script src="js/removeSchoolInfo.js" type="text/javascript"></script>
    ...
    <body onload="initialize();">
        ...
        <br>
        <center><h3>Select School to Remove Excel EMIS data</h3></center>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <input type="button" id="exportbutton" name="export" value="Remove" onclick="ajaxRemoveinfo();" disabled/>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
