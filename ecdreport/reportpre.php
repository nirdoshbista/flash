...
<html>
<head>
<title>ECD / SOP Report Cards</title>
    ...
    if (XMLHttpRequestObject.readyState == 4 && 
		...
		document.getElementById(targetdiv).innerHTML=XMLHttpRequestObject.responseText;
		  ...
		  if (targetdiv=='selectvdc'){
				ajaxDiv('reportprebe.php?req=schoollist&reporttype='+document.getElementById('r').value+'&distcode='+document.getElementById('d').value+'&vdccode='+document.getElementById('v').value,'selectschool')
		  }
		  busybox(false,"");
      } 
    } 
...
function handlechange(obj, event){
	...
	if (obj.name=='v' || obj.name=='y' || obj.name=='r'){
		ajaxDiv('reportprebe.php?req=schoollist&reporttype='+document.getElementById('r').value+'&distcode='+document.getElementById('d').value+'&vdccode='+document.getElementById('v').value+'&y='+document.getElementById('y').value,'selectschool');
...
<p align="center"><h2><center>ECD / SOP Report Cards</center></h2></p><p>&nbsp;</p>
...
<select></select>
  ...
  <br />
  Report: 
	<select name='r' id='r' onchange="return handlechange(this, event);">
